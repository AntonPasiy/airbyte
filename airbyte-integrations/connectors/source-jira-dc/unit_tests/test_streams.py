...
from source_jira_dc.source import SourceJiraDc
from source_jira_dc.streams import IssueFields, Issues, PullRequests
from source_jira_dc.utils import read_full_refresh, read_incremental
...
def test_application_roles_stream_401_error(config, caplog):
    ...
    authenticator = SourceJiraDc().get_authenticator(config=config)
