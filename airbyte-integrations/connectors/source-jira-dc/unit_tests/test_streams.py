...
import pytest
from source_jira_dc.source import JiraDcStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(JiraDcStream, "path", "v0/example_endpoint")
    mocker.patch.object(JiraDcStream, "primary_key", "test_primary_key")
    mocker.patch.object(JiraDcStream, "__abstractmethods__", set())
